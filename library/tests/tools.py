"""Test tools for the AS7343 sensor."""
import struct
...
class SMBusFakeAS7343(MockSMBus):
    """Fake the AS7343 non-standard i2c-based protocol.

    The AS7343 uses 3 registers- status, write and read.
    ...
    This mimics the AS7343's behaviour closely enough
